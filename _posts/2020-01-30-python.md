...
* [virtualenv](https://virtualenv.pypa.io/en/latest/): probably the oldest one on this list and a bit outdated. I would recommend you to also install [virualenvwrapper](https://virtualenvwrapper.readthedocs.io/) to go with it.
* [venv](https://docs.python.org/3/library/venv.html): pretty much like virtualenv but included in the standard library.
* [pipenv](https://pipenv.kennethreitz.org/en/latest/): recommended by [The Python Packaging Guide](https://packaging.python.org/guides/tool-recommendations/#application-dependency-management), combines Pipfile, pip and virtualenv into a single tool.
* [conda](https://docs.conda.io/en/latest/): heavy package and environment manager, easy to use and recommended by [PyTorch](https://pytorch.org/get-started/locally/).
